...
public interface IArchimatePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CAPABILITY__ARCHIMATE_MODEL = BUSINESS_LAYER_ELEMENT__ARCHIMATE_MODEL;
	 ...
	 * @ordered
	 */
	int CAPABILITY__ID = BUSINESS_LAYER_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int CAPABILITY__NAME = BUSINESS_LAYER_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int CAPABILITY__DOCUMENTATION = BUSINESS_LAYER_ELEMENT__DOCUMENTATION;
	 ...
	 * @ordered
	 */
	int CAPABILITY__PROPERTIES = BUSINESS_LAYER_ELEMENT__PROPERTIES;
	 ...
	 * @ordered
	 */
	int CAPABILITY_FEATURE_COUNT = BUSINESS_LAYER_ELEMENT_FEATURE_COUNT + 0;
